...
enum PartitionSize
{
    PARTITION_SIZE_BOOTLOADER = 8 * 1024,
    ...
    PARTITION_SIZE_PARAMS = 16 * 1024
};

enum PartitionAddress
{
    PARTITION_ADDRESS_BOOTLOADER = 0x08000000,
    PARTITION_ADDRESS_BOOTFROM = 0x08002000,
    PARTITION_ADDRESS_APP_A_INFO = 0x08002800,
    PARTITION_ADDRESS_APP_A = 0x08003000,
    PARTITION_ADDRESS_APP_B_INFO = 0x0800F000,
    PARTITION_ADDRESS_APP_B = 0x0800F800,
    PARTITION_ADDRESS_PARAMS = 0x0801B800
};
